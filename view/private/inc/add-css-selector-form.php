...
<fieldset class="reset d-flex flex-column align-items-center">
    ...
    <form action="" method="POST" id = "addSelectorForm" class="d-flex flex-column align-items-center"> 
        ...
        <div class="d-flex flex-row">
            <label for="labelTypeSelect" class="radioSelectLabel"></label><input type="radio" name="selectorType"id="labelTypeSelect" class="mx-1" checked value="selector">
            <label for="labelTypeId" class="radioIdLabel"></label><input type="radio" name="selectorType"id="labelTypeId" class="mx-1" value="id">
            <label for="labelTypeClass" class="radioClassLabel"></label><input type="radio" name="selectorType"id="labelTypeClass" class="mx-1" value="class">
        </div>
